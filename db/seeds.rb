...
heros = [
  ...
  { name: "Sol B.", role: "tank", picture: "app/assets/images/hero_images/sol_b.jpg", job: "paladin", guild: "The Fabulous", description: "A.K.A. Order Sol. The real bad guy", price: 400, user: User.find_by(email: "user3@hero2go.co") },
  { name: "Dan'Ghul", role: "magical", picture: "app/assets/images/hero_images/dan_ghul.jpg", job: "warlock", guild: "The Fabulous", description: "So powerful that some other warlock litteraly copy his name", price: 1500, user: User.find_by(email: "user3@hero2go.co") },
  { name: "Benedict Strange", role: "magical", picture: "app/assets/images/hero_images/benedict_strange.jpg", job: "wizard", guild: "The Fabulous", description: "The most briliant time bender", price: 1000, user: User.find_by(email: "user3@hero2go.co") },
